...
| 7 `HumanCardModal.jsx` | Closed (399 LoC) | **Reduced (2 Sept 2026)** | 544 lines: the incoming trusted-owner links and the link-on-dog action moved to `human-card/useTrustedOwnerLinks.js` (five hook tests), taking the file to 457 before #774 added the pending-signup link flow (`handlePhoneTaken` / confirm / cancel, +87). Ratchet stays at 560. Next seams: that pending-signup link flow, then the delete/archive confirm handlers. |
