...
| 12 Direct Supabase client in components | Frozen + baselined (29 files) | **Burning down** | 15 files on the allowlist; see the burn-down table under Debt 12. |
