...
|---|---|---|---|
| Staff diary booking | Yes | Yes for authorised staff | The normal dashboard route is [`/`](../src/App.jsx); [`useBookings`](../src/supabase/hooks/useBookings.ts) calls the legacy `createStaffBookingGroup` path. This remains the live staff booking authority. |
