...
**Files:**
- Create: `supabase/migrations/20260726144000_booking_visit_foundation.sql`
...
Expected: FAIL because `20260726144000_booking_visit_foundation.sql` does not exist.
...
```bash
git add supabase/migrations/20260726144000_booking_visit_foundation.sql supabase/tests/140_booking_visit_foundation.test.sql src/security/bookingVisitFoundationMigration.test.ts docs/superpowers/runbooks/2026-07-22-booking-policy-backfill-reconciliation.md
...
**Files:**
- Create: `supabase/migrations/20260726144001_authoritative_booking_policy_rules.sql`
...
```bash
git add supabase/migrations/20260726144001_authoritative_booking_policy_rules.sql supabase/tests/145_booking_policy_rules.test.sql src/security/bookingPolicyRulesMigration.test.ts
...
**Files:**
- Create: `supabase/migrations/20260726144002_visit_deposits_incidents_credits.sql`
...
```bash
git add supabase/migrations/20260726144002_visit_deposits_incidents_credits.sql supabase/tests/150_visit_deposits_incidents_credits.test.sql src/security/bookingPolicyLedgerMigration.test.ts docs/superpowers/runbooks/2026-07-22-booking-policy-backfill-reconciliation.md
...
**Files:**
- Create: `supabase/migrations/20260726144004_customer_visit_commands.sql`
...
```bash
git add supabase/migrations/20260726144004_customer_visit_commands.sql supabase/tests/155_customer_visit_commands.test.sql src/supabase/rpc.ts src/supabase/repositories/bookingsRepo.ts src/supabase/repositories/bookingsRepo.test.ts
...
**Files:**
- Create: `supabase/migrations/20260726144005_staff_visit_policy_commands.sql`
...
```bash
git add supabase/migrations/20260726144005_staff_visit_policy_commands.sql supabase/tests/160_staff_visit_policy_commands.test.sql src/supabase/rpc.ts src/supabase/repositories/bookingPolicyRepo.ts src/supabase/repositories/bookingPolicyRepo.test.ts
...
**Files:**
- Create: `supabase/migrations/20260726144006_visit_policy_events.sql`
...
```bash
git add supabase/migrations/20260726144006_visit_policy_events.sql supabase/tests/165_visit_policy_events.test.sql src/engine/reportsAnalytics.ts src/engine/reportsAnalytics.test.ts src/lib/bookingEventFormat.js src/lib/bookingEventFormat.test.js src/supabase/database.types.ts
