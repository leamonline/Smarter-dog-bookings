...
**Files**
- Create `supabase/migrations/20260723100000_staff_visit_write_commands.sql`
...
**Files**
- Create `supabase/migrations/20260723110000_booking_policy_projections.sql`
...
**Files:** `supabase/migrations/20260723120000_customer_change_requests.sql`,
...
**Files:** `supabase/migrations/20260723130000_whatsapp_policy_acknowledgement.sql`,
...
**Files:** `supabase/migrations/20260723140000_booking_policy_activation.sql`,
