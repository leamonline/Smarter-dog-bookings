...
console.log(`     supabase secrets set VAPID_SUBJECT=mailto:leam@leamonline.uk`);
console.log(`     supabase secrets set STAFF_PUSH_ENABLED=true   # when ready to go live\n`);
