...
const STATE_STYLE = {
    open: { bg: 'rgba(255,255,255,0.9)', color: colors.plum, label: 'Open' },
    closed: { bg: 'rgba(255,255,255,0.25)', color: 'white', label: 'Closed' },
            ...
            >
                <span className="inline-flex items-center gap-1.5">
                    <span
                        ...
                        style={{ backgroundColor: 'rgba(255,255,255,0.9)', border: `1px solid ${colors.plum}` }}
                    />
                    Open
                </span>
                <span className="inline-flex items-center gap-1.5">
