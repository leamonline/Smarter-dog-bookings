...
export function WaitlistNote({ currentDateObj, humans, dogs, onOpenHuman }) {
  ...
  return (
    <div ref={ref} className="relative snap-center shrink-0">
      ...
      {open && (
        <div className="absolute top-full right-0 mt-1 z-50 w-[280px] aspect-square bg-[#FFFBF2] border border-[#F5E6C8] rounded-md shadow-[0_4px_20px_rgba(0,0,0,0.12),0_2px_6px_rgba(0,0,0,0.06)] p-4 flex flex-col animate-[fadeIn_0.12s_ease-out]">
          {/* Tape strip */}
