                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className="text-sm font-semibold text-brand-cyan-dark font-[Montserrat]">{formatDate(b.booking_date)}</span>
                      <span className="text-[10px] font-bold bg-emerald-50 text-emerald-700 py-0.5 px-2 rounded font-[Montserrat] uppercase tracking-wide">Upcoming</span>
                    </div>
                    <div className="text-sm font-semibold text-brand-cyan-dark">
                      {b.dogs?.name || "Unknown"}{" "}
