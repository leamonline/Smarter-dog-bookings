...
export function IconTick({ size = S, colour = BRAND.blue }) {
...
export function IconBlock({ size = S, colour = BRAND.coral }) {
...
export function IconReopen({ size = S, colour = BRAND.teal }) {
...
export function IconEdit({ size = S, colour = BRAND.blue }) {
...
export function IconMessage({ size = S, colour = BRAND.teal }) {
...
export function IconPlus({ size = S, colour = BRAND.blue }) {
...
export function IconSearch({ size = S, colour = BRAND.textLight }) {
