import { BRAND, ALL_DAYS } from "../../constants/index.ts";
import type { BookingsByDate, DateInfo } from "../../types.ts";

interface WeekArrowBtnProps {
  direction: "left" | "right";
  onClick: () => void;
}

function WeekArrowBtn({ direction, onClick }: WeekArrowBtnProps) {
  return (
...
export function WeekNav({ selectedDay, onSelectDay, bookingsByDate, dates, dayOpenState, onPrevWeek, onNextWeek }: WeekNavProps) {
  return (
