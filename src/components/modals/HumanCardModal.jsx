...
export function HumanCardModal({ humanId, onClose, onOpenHuman, onOpenDog }) {
      ...
      <div onClick={(e) => e.stopPropagation()} style={{
        ...
        <div style={{ padding: "16px 24px 20px" }}>
          ...
          <button style={{
            ...
            background: BRAND.tealLight, color: BRAND.teal, fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit",
          }}>+ Add a trusted Human</button>
        </div>
      </div>
    </div>
  );
