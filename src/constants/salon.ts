import type { Service, DayConfig, LargeDogSlotConfig, AlertOption } from "../types.ts";
...
] as const satisfies readonly DayConfig[];

export const LARGE_DOG_SLOTS: Record<string, LargeDogSlotConfig> = {
...
] as const satisfies readonly AlertOption[];
