import type { HumansMap, DogsMap, Booking } from "../types.ts";

export const SAMPLE_HUMANS: HumansMap = {
...
export const SAMPLE_DOGS: DogsMap = {
  ...
  "Daisy": { id: "d5", name: "Daisy", breed: "Poodle", age: "1 yr", humanId: "Lisa Brown", alerts: [], groomNotes: "" },
  "Milo": { id: "d6", name: "Milo", breed: "Maltese", age: "6 yrs", humanId: "Jenny Taylor", alerts: [], groomNotes: "" },
  "Rex": { id: "d7", name: "Rex", breed: "Labrador", age: "7 yrs", humanId: "Mark Johnson", alerts: [], groomNotes: "" },
};

export const SAMPLE_BOOKINGS_BY_DAY: Record<string, Booking[]> = {
  mon: [
