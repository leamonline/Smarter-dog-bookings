...
create trigger booking_policy_settings_updated before update on public.booking_policy_settings
...
begin
  ...
  update public.booking_policy_settings set updated_by = auth.uid() where singleton;
